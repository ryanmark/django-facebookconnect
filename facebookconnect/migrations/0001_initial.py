...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FacebookTemplate'
        db.create_table('facebookconnect_facebooktemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
            ('template_bundle_id', self.gf('django.db.models.fields.BigIntegerField')()),
        ))
        db.send_create_signal('facebookconnect', ['FacebookTemplate'])

        # Adding model 'FacebookProfile'
        db.create_table('facebookconnect_facebookprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('facebookconnect', ['FacebookProfile'])


    def backwards(self, orm):
        
        # Deleting model 'FacebookTemplate'
        db.delete_table('facebookconnect_facebooktemplate')

        # Deleting model 'FacebookProfile'
        db.delete_table('facebookconnect_facebookprofile')
